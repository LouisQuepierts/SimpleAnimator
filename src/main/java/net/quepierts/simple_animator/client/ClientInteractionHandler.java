...
import net.quepierts.simple_animator.common.PlayerUtils;
import net.quepierts.simple_animator.network.ModNetwork;
import net.quepierts.simple_animator.network.packet.InteractAcceptPacket;
import net.quepierts.simple_animator.proxy.ClientProxy;
